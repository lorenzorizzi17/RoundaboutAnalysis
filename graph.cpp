...
void graph(){
    ...
    double mean[11] = {0.6,0.7,0.819, 0.982,1.182,1.458,1.822,2.411,3.41,6.09,15.49};
    double sd[11] = {0.47,0.53,0.59,0.68,0.80,0.94,1.15,1.48,2.01,3.80,9.73};
